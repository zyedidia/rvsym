...
$(sim): $(synth)
	yosys -m $(YOSIM_SO) -q -p 'read_verilog $(INC) -DSIM $(DEFINE) -noautowire -sv $(synth); hierarchy -top $(sim_top); write_yosimcxx -nohierarchy -O4 $(sim)'

$(sim_top)_tb: $(sim) $(tb)
	$(CXX) $(CXX_FLAGS) -I$(YOSYS_INCLUDE) -I$(YOSIM_INCLUDE) $(tb) -o $@
